...
= Talkdesk Connector Documentation Reference
...
| oAuth Client Id a| String |  |  | *x*{nbsp}
| oAuth Client Secret a| String |  |  | *x*{nbsp}
...
==== Throws
* TALKDESK:CONNECTIVITY {nbsp}
* TALKDESK:RETRY_EXHAUSTED {nbsp}


[[getContacts]]
=== List account contacts
`<talkdesk:get-contacts>`
